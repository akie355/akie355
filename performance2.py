...
predict = np.zeros(shape=(len(yhat), 1))         # åöôéáîá np.array ìå ôïí éäéï áñéèìü óôçëùí ãéá íá ìðïñåé íá ãßíåé ôï inverse óôéò ôéìåò ôïõ prediction
predict[:,0] = yhat                              #âÜæù ôéò ôéìåò ðïõ ðñïåâëåøá 

inv_yhat = scaler.inverse_transform(predict)    #êÜíù ôï inverse_transform
                                                #êñáôÜù ìüíï ôçí óôÞëç ðïõ èÝëù ãéá íá õðïëïãßóù ôï Root mean square error
...
inv_y = scaler.inverse_transform(actual)    #êÜíù ôï inverse_transform
                                            #êñáôÜù ìüíï ôçí óôÞëç ðïõ èÝëù ãéá íá õðïëïãßóù ôï Root mean square error
...
inv_x = scaler.inverse_transform(actual)    #êÜíù ôï inverse_transform
                                            #êñáôÜù ìüíï ôçí óôÞëç ðïõ èÝëù ãéá íá õðïëïãßóù ôï Root mean square error
